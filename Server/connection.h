...
public:
    ...
    public:
        ...
        Connection(TCPSocket& serverSocket, std::map<std::string, SOCKET>& cList)
        {
        ...
        static void handle_connection(SOCKET clientSocket, std::map<std::string, SOCKET>& cList)
        {
            bool logged = false;
    ...
    static void exec()
    {
        ...
        std::map<std::string, SOCKET> clientList;
